...
public class FollowNewsAdapter extends RecyclerView.Adapter<FollowNewsAdapter.MHolder> {

    private Context context;
    private List<TrendBean.DataDTO> list;

    public FollowNewsAdapter(Context context, List<TrendBean.DataDTO> list){
    ...
    public MHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        return new MHolder(LayoutInflater.from(context).inflate(R.layout.item_follow_one_recyc, parent, false));
    }
